...
<center><h2>REPORTE DE EXISTENCIA DE PRODUCTOS</h2></center> 
<hr  /><!--Linea horizontal-->
<?php
...
if(!empty($_POST))
{
      ...
      $query ="Select *  
      from producto WHERE Nombre like '%" . $aKeyword[0] . "%'";
     ...
     if(mysqli_num_rows($result) > 0) {
        ...
        While($row = $result->fetch_assoc()) {   
            $row_count++;                         
            echo "<tr><td>".$row_count." </td><td>". $row['Nombre'] . "</td><td>". $row['Categoria'] . "</td><td>$". $row['precio'] . "</td></tr>";
        }
        echo "</table>";
