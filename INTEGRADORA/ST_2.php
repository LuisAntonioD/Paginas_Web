...
<center><h2>REPORTE DE TOTAL DE COMPRA DE CLIENTES</h2></center> 
<hr  /><!--Linea horizontal-->
<?php
...
?>
        ...
        <div class="col col-md-9">                   
                    ...
                    <div class="container mb-5">
                            ...
                            <a href="admin_prod_home.php?accion=cambio&usuario=<?= $usuario ?>&u=<?= $u ?>&s=<?= $s ?>" class="nav-link text-success">Productos <i class="fas  fa-store "></i>&nbsp&nbsp&nbsp<span class="badge bg-primary rounded-pill col-md-1">17</span></a>
                            <a href="most_usu.php?<?= $usuario ?>&u=<?= $u ?>&s=<?= $s ?>" class="nav-link text-danger">Usuarios <i class="fas fa-user"></i>&nbsp&nbsp&nbsp<span class="badge bg-primary rounded-pill col-md-1">5</span></a>
                            <a href="Repadmin.php?<?= $usuario ?>&u=<?= $u ?>&s=<?= $s ?>" class="nav-link text-warning">Reportes <i class="fas fa-paper-plane"></i></i>&nbsp&nbsp&nbsp<span class="badge bg-primary rounded-pill col-md-1">10</span></a>
                            <br><br><br><br><br><br><br>
                            <center><img src="images/oster.png" class="rounded" style="width:50px">
