...
<title>ELECTRODOMEX</title>
  <link rel="icon" type="image/jpg" href="images/Logoindex.svg">
	 <!--css de brootstrap-->
	<link href="Footstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <!--css de fontawesome-->
		...
		<tr>
			...
			<td class="info_empresa">
				<div>
					...
					<p>Robles Jurica 12, Querétaro</p>
					<p>Teléfono: +(442) 234 56 78</p>
					<p>Email: electrodomex.com.mx.net</p>
				</div>
			</td>
...
?>
			...
			<tfoot id="detalle_totales">
				<tr>
					...
					<td class="textright"><span>$<?= number_format( $total_sin_iva,2, ".", "," ) ?></span></td>
				</tr>
				<tr>
					<td colspan="3" class="textright"><span>IVA (16%)</span></td>
					<td class="textright"><span>$<?= number_format( $total_sin_iva * 0.16,2, ".", "," ) ?></span></td>
				</tr>
				<tr>
					<td colspan="3" class="textright"><span>TOTAL </span></td>
					<td class="textright"><span>$<?= number_format( $total_sin_iva * 1.16,2, ".", "," ) ?></span></td>
				</tr>
		</tfoot>
	</table>
	<div>
