...
if( isset( $_SESSION[ "correo" ] ) && isset( $_SESSION[ "token" ] ) ){
  valida_tipo( $_SESSION["correo"],$_SESSION["token"] );
  exit(0);
}
?>
...
<div class="p-1  bg-secondary text-white">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <ul class="menu" >
                    ...
                    <li>
                      <a href="Sucursales.html" class="nav-link" aria-current="page" href="#">
                        Sucursales
                  ...
                  <div class="col col-md-9"></div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  ...
  <div class="bg-dark">
              ...
              <a href="admin.php" class="btn btn-outline-warning btn-min">
  ...
  <div class="container marketing mt-5">
    ...
    <div class="row">
      ...
      <div class="col col-lg-4 mt-5">
        ...
        <p><a class="btn btn-outline-dark" href="./categoria.php?idsu=1">Comprar &raquo;</a></p>
      </div></center><!-- /.col-lg-4 -->
      <div class="col col-lg-4 mt-5">
        ...
        <p>Some representative placeholder content for the three columns of text below the carousel. This is the first column.</p>
        <p><a class="btn btn-outline-dark" href="./categoria.php?idsu=2">Comprar&raquo;</a></p>
      </div></center><!-- /.col-lg-4 -->
      <div class="col col-lg-4 mt-5">
        ...
        <p>Some representative placeholder content for the three columns of text below the carousel. This is the first column.</p>
        <p><a class="btn btn-outline-dark" href="./categoria.php?idsu=3">Comprar &raquo;</a></p>
      </div></center><!-- /.col-lg-4 -->
...
<section class="">
<a href="admin.php" class="btn btn-outline-dark btn-min mt-2">
