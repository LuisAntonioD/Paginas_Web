    ...
    switch ( $accion ) {
        case "alta":
            ...
            if ( $rs -> num_rows > 0) {
                ...
                desconectar();
                header ( "location:trabajo6_formulario.php?accion=alta&msgcode=4" ); //Te redirecciona a otra pagina 
                exit ( 0 );
            }
...
desconectar();
header ( "location:Trabajo6.php".( $msgcode != 0 ? "?msgcode=$msgcode" : "" ) ); //Te redirecciona a otra pagina 
